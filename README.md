...
* **⚙️ Sistemas y Entornos:** Administración avanzada y personalización de Linux, administración remota segura (SSH), y optimización/gestión de entornos Windows y MacOS.
* **🛡️ Herramientas y Ciberseguridad:** Scripting en Bash, análisis de vulnerabilidades (inyección SQL, wardriving), estructuración de bases de datos, desarrollo web y control de versiones (Git).
* **🔌 Hardware y Electrónica:** Desarrollo con sistemas embebidos (SAMD21, Microchip, M5Stack-ESP32, Arduino). Integración de transceptores RF (NRF24L01, CC1101), módulos Rx/Tx IR, programación de interfaces HMI (pantallas Nextion), análisis de señales PWM e implementación de firmware para auditorías de protocolos inalámbricos.
* **🎧 Audio de Alta Fidelidad:** Instalación, configuración y optimización de cadenas Hi-Fi, y gestión de formatos de audio de alta resolución.
