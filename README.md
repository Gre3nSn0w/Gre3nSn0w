...
* ** Herramientas y Ciberseguridad:** Scripting en Bash, análisis de vulnerabilidades (inyección SQL, wardriving), estructuración de bases de datos, desarrollo web y control de versiones (Git).
